...
// Telescope.registerComponent("PostsCommentsThread", equire('./posts/PostsCommentsThread.jsx'));
...
// Telescope.registerComponent("CategoriesEditForm",
// require('./categories/CategoriesEditForm.jsx'));
